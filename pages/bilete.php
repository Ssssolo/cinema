                                ...
                                <div class="card-body">
									<table id="example2" class="table table-bordered table-striped">
										...
										<tbody>
											...
											?>
                                            <tr>
												<td><?php echo (is_numeric($info_rez['id']) && !empty($info_rez['id'])) ? $info_rez['id'] : '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?></td>
                                                <td>
													<?php
													echo !empty($info_user['nume']) ? $info_user['nume'].' ' : '<i style="color:red; font-weight:bold;"># Nedefinit</i> ';
													echo !empty($info_user['prenume']) ? $info_user['prenume'] : '<i style="color:red; font-weight:bold;"># Nedefinit</i>';
													?>
												</td>
                                                <td><?php echo !empty($info_user['email']) ? $info_user['email'] : '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?></td>
                                                <td><?php echo !empty($info_user['telefon']) ? nr_tel($info_user['telefon']) : '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?></td>
                                                <td><?php echo !empty($info_film['titlu']) ? $info_film['titlu']: '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?></td>
                                                <td><?php echo !empty($info_rez['locuri']) ? $info_rez['locuri']: '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?></td>
                                                <td><?php echo !empty($info_rez['pret']) ? $info_rez['pret']: '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?> LEI</td>
