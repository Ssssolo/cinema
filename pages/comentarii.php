...
<html>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<table id="example2" class="table table-bordered table-striped">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $info_user['nume'].' '.$info_user['prenume'];?></td>
                                                <td><?php echo !empty($info_articol['titlu']) ? $info_articol['titlu'] : '<i style="color:red; font-weight:bold;"># Nedefinit</i>';?></td>
                                                ...
                                                <td>
													<button class="btn btn-info" data-toggle="modal" data-target="#editare" onclick="mod_edit('<?php echo filter_var($rand['text'],FILTER_SANITIZE_SPECIAL_CHARS).'\', \''.$info_user['id']; ?>');"><i class="fa fa-edit"></i></button>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-info" id="editare_fin" data-id>Editare</button>
					</div>
				</div>
			</div>
		</div>
		...
		function mod_edit(com, id){
			$('#text').html(com);
			$("#editare_fin").attr('data-id', id);
		}
