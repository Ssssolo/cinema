							...
							<div class="col-md-6">
								<div class="card card-<?php echo culoare_card(isset($_POST['submit']) ? 1 : 0, $eroare); ?>">
									<div class="card-header">
										<?php echo mesaj_card(isset($_POST['submit']) ? 1 : 0, $eroare, "Editare utilizator"); ?>
									</div>
									<div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" disabled class="form-control" value="<?php echo !empty($rand['IP']) ? $rand['IP'] : "# Nedefinit"; ?>">
											</div>
                                            <!-- /.input group -->
										</div>
                                        <!-- /.form group -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
												...
												<textarea type="text" disabled class="form-control" rows="5"></textarea>
											</div>
                                            <!-- /.input group -->
										</div>
                                        <!-- /.form group -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" disabled class="form-control" rows="3"><?php echo !empty($rand['user_agent']) ? $rand['user_agent'] : "# Nedefinit"; ?></textarea>
											</div>
                                            <!-- /.input group -->
										</div>
                                        <!-- /.form group -->
